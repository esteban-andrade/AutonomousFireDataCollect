...

{
  ...
  sensors_pub_ = nh_.advertise<std_msgs::String>("sensors/data", 1000);
  ros::NodeHandle pn("~");
}
...
void Control::sensorsDataPublisherThread(void)
{
